      ...
      <div className="flex mt-2 p-6">
        <div className=" w-1/2 p-2 bg-[url('/img/logo1.png')] bg-cover bg-center  relative">
          <div className="absolute inset-0 bg-yellow-50/95  text-white flex flex-col justify-center p-5">
            <h1 className=" font-sans font-bold text-4xl text-center text-[#7C504A]">
              About Us
            </h1>
            <p className=" text-black text-xl text-justify px-10 py-5">
        ...
        <div className="h-full w-1/2 p-2 grid grid-cols-2 place-content-center gap-y-4">
          <h1 className="text-[#7C504A] font-sans font-bold text-2xl col-span-2  h-10">
            Services We Offer
          </h1>

          <ul>
            <li>
              <span className="flex items-center space-x-2 font-bold text-[#7C504A]  ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 640 640"
                  className="w-6 h-6 inline-block fill-[#7C504A] "
                >
          ...
          <ul>
            <li>
              <span className="font-bold text-[#7C504A] flex space-x-2 items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 640 640"
                  className="w-6 h-6 inline-block fill-[#7C504A]"
