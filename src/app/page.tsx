  ...
  return (
    <main className="min-h-screen">
      <div className="w-full h-[80vh] grid grid-cols-3">
        <div className="col-span-2 text-white flex flex-col justify-center p-5 items-center">
          <h1 className=" font-sans font-bold text-6xl text-center">
            Find Skilled Professionals Near You - Book in Minutes
          </h1>
          <p className="text-xl text-justify px-10 py-5  mt-10">
            <span className="text-[#EA2849] text-2xl"> &#10003;</span>
            BETTA connects skilled professionals with clients valuing quality
            and reliability, offering a seamless platform for technical
            expertise, creative solutions, or specialized support.
          </p>
          <p className="text-xl text-justify px-10">
            <span className="text-[#EA2849] text-2xl"> &#10003;</span>
            Whether you need a service or want to offer your skills, we make it
            simple. Book trusted experts or become a provider.
          </p>
        </div>

        <div className="object-cover grid place-items-center">
          <img src="/image/home.png" alt="home" />
        </div>
      </div>

      <div className="h-full w-full  grid grid-cols-3 place-content-center gap-y-10 px-15 pb-10">
        <h1 className=" font-sans font-bold text-4xl col-span-3  h-10 text-center mb-10">
          Services We Offer
        </h1>
        ...
        <ul className="text-xl">
          <li>
            <span className="font-bold flex space-x-2 items-center">
              ...
              <p className="text-2xl">Tech & IT Support</p>
            </span>
            <ul className="list-disc list-inside ml-6">
        ...
        <ul className="text-xl">
          <li>
            <span className="font-bold flex space-x-2 items-center">
              ...
              <p className="text-2xl">Creative & Design</p>
            </span>
            <ul className="list-disc list-inside ml-6">
        ...
        <ul className="text-xl">
          <li>
            <span className="font-bold flex space-x-2 items-center">
              ...
              <p className="text-2xl">Cleaning & Maintenance</p>
            </span>
            <ul className="list-disc list-inside ml-6">
        ...
        <ul className="text-xl">
          <li>
            <span className="font-bold flex space-x-2 items-center">
              ...
              <p className="text-2xl">Tutoring & Education</p>
            </span>
            <ul className="list-disc list-inside ml-6">
        ...
        <ul className="text-xl">
          <li>
            <span className="font-bold flex space-x-2 items-center">
              ...
              <p className="text-2xl">Skilled Labor & Others</p>
            </span>
            <ul className="list-disc list-inside ml-6">
